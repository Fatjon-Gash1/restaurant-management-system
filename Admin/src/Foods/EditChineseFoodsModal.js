...
export class EditChineseFoodsModal extends Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit(event) {
        ...
        fetch('https://localhost:44365/api/chinesefoods', {
            ...
            body: JSON.stringify({
                ChineseFoodsId: event.target.ChineseFoodsId.value,
                        ...
                        <Row>
                            <Col sm={6}>
                                <Form onSubmit={this.handleSubmit}>
                                    <Form.Group controlId="ChineseFoodsId">
                                        <Form.Label>Numri</Form.Label>
                                        <Form.Control type="text" name="ChineseFoodsId" required
                                            placeholder="Stypni numrin"
                                            disabled
                                            defaultValue={this.props.chinesefoodsid} />
                                    </Form.Group>
                                    ...
                                    <Form.Group controlId="ChineseFoodsName">
                                        ...
                                        <Form.Control type="text" name="ChineseFoodsName" required
                                            defaultValue={this.props.chinesefoodsname}
