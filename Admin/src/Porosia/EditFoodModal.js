        ...
        <Row>
            <Col sm={6}>
                ...
                <Form.Group controlId="Kodi">
                        ...
                        <Form.Control as="select"required defaultValue={this.props.kodi}>
                        <option value="">Zgjedh Tavolinën</option>
                        {this.state.kodi.map(kodi=>
                            <option key={kodi.KodiId}>{kodi.KodiName}</option>)}
                        </Form.Control>
                    </Form.Group>
                    ...
                    <Form.Group controlId="Desserts">
                        ...
                        <option value="">Zgjedh Ëmbëlsirën</option>
                    ...
                    <Form.Group controlId="Salads">
                        ...
                        <option value="">Zgjedh Sallatat</option>
                    ...
                    <Form.Group controlId="Other">
                        ...
                        <option value="">Zgjedh Ushqime të Tjera</option>
